 ...
 * Searches for specifically named svg in Streaming Assets Folder
 * Creates a CCT-Plate Object in Scene. Drag it out of Hierarchy Window to Assets Folder to save it as prefab
 */
...
public class SVGCircleReader : MonoBehaviour
{
    ...
    void Start()
    {
        string path = Path.Combine(Application.streamingAssetsPath, "ishihara(2).svg");
        if (!File.Exists(path))
        {
    ...
    void CreateGOwithParent(List<CircleData> dat)
    {
        ...
        parentContainer.gameObject.AddComponent(typeof(TestPlate));
    }
